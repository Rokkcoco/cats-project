...
const catsInfoInstance = new CatsInfo('#cats-info-template', handleEditCatInfo, handleLike, handleDeleteCat);
const catsInfoElement = catsInfoInstance.getElement();

function createCat(dataCat) { // функция добавления кота
    const cardInstance = new Card(dataCat, '#card-template', handleCatImage, handleCatTitle, handleLike);
